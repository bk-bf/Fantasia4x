...
| **3** | **Finish Race → Culture System** | `[-]` | [RACE-SYSTEM](RACE-SYSTEM.md) — Ph0 done; `Race`→`Culture` rename **done 2026-07-13** (Culture throughout code+UI, no `race*` ids/strings left). Only Ph1 (relations→social baseline) remains, **blocked on #4** |
