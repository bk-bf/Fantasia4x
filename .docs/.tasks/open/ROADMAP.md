...
| **Work experience system** (per-pawn 1–50 exp level per work category drives speed/yield/quality; core stats demoted to tertiary supplement; per-pawn speed↔quality style bias; per-unit batch quality roll; Attributes/Work tab UI split, medical→caretaking speed+quality) | [ ]                 | [WORK-EXPERIENCE.md](WORK-EXPERIENCE.md); fixes runaway masterwork at the new 0–100 stat ceiling + adds progression |
