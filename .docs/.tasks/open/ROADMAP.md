...
| 2c | **Engine Performance & Scaling** — P0 pre-filter (`mobSubsets()`) **landed**, behaviour-preserving (218 tests); awaiting browser-sandbox numbers to confirm the `pawns`-phase drop. Then persistence/push/LoS (P1–P3), gated on the spike passing                            | [-] spike: validating | [ENGINE-PERFORMANCE.md](ENGINE-PERFORMANCE.md) §6 · ADR-018/019/020                                       |
