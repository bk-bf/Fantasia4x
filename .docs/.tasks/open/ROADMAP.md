...
| 3  | **Living World B–D** (seasons, temperature, weather, fog of war)                                                                                                                                                       | [~] B+C(gameplay) done 2026-06-16; weather particles + fog(D) deferred | [SEASONS_WEATHER.md](SEASONS_WEATHER.md)                                                                  |
...
| Item                                                                                                          | Status              | Notes                                                                             |
| ------------------------------------------------------------------------------------------------------------- | ------------------- | --------------------------------------------------------------------------------- |
| **Per-stack craft quality on instances** (R8, moved from CODEBASE-REVIEW 2026-06-16)                          | [ ] blocked         | Crafting computes a `quality` work-axis but never stamps it on the output instance, and nothing reads item `.quality` (Combat/PawnStatService/PawnEquipment). **Blocked on:** equipment quality affecting combat/equip — do the two together (quality stamp + consumer). |
