...
- [x] **NT-U1 · Toggleable health panel** in the info panel showing only damaged limbs/wounds; "no damage"
  when all healthy.
- [x] **NT-U2 · Info-panel buttons** moved adjacent (right) and outside the panel.
- [x] **NT-U3 · Fixed-width info-panel skeleton** so long descriptions wrap instead of stretching the
