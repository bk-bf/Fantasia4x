...
> **Related:** [`scripts/build-distance.sh`](../../scripts/build-distance.sh) · [`scripts/hooks/pre-commit`](../../scripts/hooks/pre-commit)
...
every commit (watches `.git/logs/HEAD`), when the window regains focus, and on a 30s fallback poll.
