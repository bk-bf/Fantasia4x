# AUDIT — archived 2026-08-25

> **Related:** [issues/README](../../issues/README.md) · [ROADMAP](../open/ROADMAP.md) · [COMBAT-BALANCE](../open/COMBAT-BALANCE.md) · [tools/audit](../../../tools/audit/README.md)

**Superseded by [`docs/issues/`](../../issues/README.md).** This file is the completed record of the
headless-sim content and gameplay audits; it is no longer a live tracker and nothing new is ticked
here. Its unfinished items were carried over on 2026-08-25:

| Was | Now |
|---|---|
| Caster line + `great_bone_maul` on `R4_DEBT` | [caster-weapon-line-age](../../issues/caster-weapon-line-age.md) |
| Dead `slash`/`pierce`/`crushResistance` fields | [armour-resistance-fields-dead](../../issues/armour-resistance-fields-dead.md) |
| Derived-weight recipe defects | [recipe-derived-weight-defects](../../issues/recipe-derived-weight-defects.md) |
| Mobs blocking with no shield | [mobs-innate-block](../../issues/mobs-innate-block.md) |
| Per-weapon T4 tracker + `wieldRequirement` | [t4-weapon-fight-verification](../../issues/t4-weapon-fight-verification.md) |
| Medium-armour holes + no runed shield | [armour-coverage-holes](../../issues/armour-coverage-holes.md) |
| `mana_crystal` dead end + `make_ash` shadow | [mana-crystal-dead-end](../../issues/mana-crystal-dead-end.md) |
| Early–mid apparel gap · wound medicine · runic redesign | ROADMAP rows **8f**, **8g**, **8h** |
| Weapons § balance findings | [COMBAT-BALANCE](../open/COMBAT-BALANCE.md) Phase 4 |

Two findings recorded below were fixed before the carry-over and are left in place as history: the
`*Penalty` sign inversion (now the reverse assertion at `t4WeaponAudit.test.ts:176`) and DEXTERITY
dominating every melee weapon (resolved by the two-axis rebuild).
...
> **The fix list for everything ⚠ below lives in [COMBAT-BALANCE](../open/COMBAT-BALANCE.md)** — 14 tasks in 5
