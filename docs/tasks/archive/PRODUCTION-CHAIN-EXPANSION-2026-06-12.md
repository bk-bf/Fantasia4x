...
> **Status: [x] COMPLETE — archived 2026-06-12.**
> **Related:** [ROADMAP](../open/ROADMAP.md) · [EQUIPMENT-EXPANSION](../open/EQUIPMENT-EXPANSION.md) · [RESEARCH-ENHANCEMENT](../open/RESEARCH-ENHANCEMENT.md) · [SEASONS_WEATHER (Living World)](SEASONS_WEATHER-2026-06-17.md) · [PROCEDURAL-METALS](PROCEDURAL-METALS.md) (follow-up) · [game/DESIGN](../../game/DESIGN.md) · archived: [SURVIVAL-HEALTH-2026-05-30](SURVIVAL-HEALTH-2026-05-30.md)

## Status

**[x] COMPLETE — build green** (`pnpm check` 0 errors; **113 tests**). Every chapter (§A–§G,
...
SEASONS_WEATHER](SEASONS_WEATHER-2026-06-17.md); endgame procedural metals →
...
- Food rot from **exposure to the elements** (rain, heat, frost) → owned by
  [Living World / SEASONS_WEATHER](SEASONS_WEATHER-2026-06-17.md) Phase B. This spec handles
...
- [ ] Roof rendering as a transparent shade-casting overhead layer → [SEASONS_WEATHER](SEASONS_WEATHER-2026-06-17.md) lighting pass.
- [ ] Direct fire-adjacency fire-spread risk → [SEASONS_WEATHER](SEASONS_WEATHER-2026-06-17.md) Living World.
