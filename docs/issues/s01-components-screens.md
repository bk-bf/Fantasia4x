...
- [`src/lib/components/screens/DebugGodmode.svelte:19`](../../src/lib/components/screens/DebugGodmode.svelte#L19) — STAT_KEYS hand-writes all six members of the EntityStats interface, so a seventh stat added to EntityStats would silently be missing from the godmode stat dropdown.
