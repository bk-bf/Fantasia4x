...
> **Related:** [CORE-STAT-SINGLE-SOURCE](../tasks/open/CORE-STAT-SINGLE-SOURCE.md) — the full analysis · [issues/README](README.md) · [game/ARCHITECTURE](../game/ARCHITECTURE.md)
