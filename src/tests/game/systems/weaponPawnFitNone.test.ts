...
/**
 * WEAPON × PAWN FIT — target in NONE armour.
 *
...
describe('WEAPON x PAWN FIT — target in none armour', () => {
  it('every weapon, in well-suited / average / poor hands', async () => {
    ...
    console.log(
      `[WEAPON x PAWN FIT · target in NONE] ${fights} fights per cell, wins and damage per landed hit\n` +
