...
import { moveCostToEnter } from '$lib/game/services/MovementSystem';
import { tileWetness } from '$lib/game/services/EnvironmentService';
import type { GameState, WorldTile, PlacedBuilding } from '$lib/game/core/types';
