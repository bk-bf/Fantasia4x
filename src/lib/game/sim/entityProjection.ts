...
// only by MemoryService/SocialService in the worker; stealthChecks: STEALTH per-pawn detection
// cache on mobs, read only by entityAI/Combat — none are rendered).
const ENTITY_DROP = [
  'jobQueue',
  'hideWear',
  'hideWearAt',
