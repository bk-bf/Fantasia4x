...
import { depositInventory, REHAUL_COOLDOWN_TICKS } from './pawnHauling';
import { generate as generateHaul } from '../../services/jobs/haul';
import type { GameState, Pawn, DroppedItem } from '../../core/types';
