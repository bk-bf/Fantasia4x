...
/** Opening-game safety bubble around the colony start (the actual placed pawns — see `inStartingBubble`):
 *  no lair packs seed, repopulate, or grow within this radius for the first in-game month, so the player isn't
