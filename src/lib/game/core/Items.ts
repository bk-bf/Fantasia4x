...
export const ITEMS_DATABASE: Item[] = [
	...
	},
	{
		...
		rarity: 'common',
		nutrition: 1.4,
		effects: { coldResistance: 0.3, storageStability: 0.9 },
		researchRequired: null,
		emoji: '🌾',
		color: '#D4AF37',
		amount: 0,
	...
	},
	{
		...
		rarity: 'common',
		nutrition: 0.5,
		effects: { healthBonus: 0.15, flavorEnhancement: 0.2 },
		researchRequired: null,
		emoji: '🌿',
		color: '#4CAF50',
		amount: 0,
	...
	},
	{
		...
		rarity: 'uncommon',
		nutrition: 1.8,
		effects: { healthBonus: 0.4, moralBonus: 0.2 },
		researchRequired: null,
		emoji: '🐟',
		color: '#FF8A65',
		amount: 0,
	...
	},
	{
		...
		rarity: 'uncommon',
		nutrition: 2.5,
		effects: { proteinBonus: 0.6, morale: 0.2 },
		researchRequired: null,
		emoji: '🥩',
		color: '#8D4E85',
		amount: 0,
	...
	},
	{
		...
		description:
			'Masterwork steel hammer with yew handle, bronze fittings, and ornate leather grip',
		type: 'weapon',
		category: 'combat',
		level: 2,
		rarity: 'epic',
	...
	},
	{
		...
		name: 'Steel Sword',
		description:
			'Superior steel blade with yew handle, bronze fittings, and masterwork leather grip',
		type: 'weapon',
		category: 'combat',
		level: 2,
		rarity: 'epic',
	...
	// ===== PHASE 6a — PRIMITIVES =====
	{
		...
		type: 'material',
		category: 'organic',
		description: 'A dry twig. Burns quickly.',
		emoji: '🪵',
		color: '#8B6914',
		amount: 0,
		fuelValue: 3,
	...
	},
	{
		...
		type: 'material',
		category: 'stone',
		description: 'A sharp flint chip. Primitive cutting edge.',
		emoji: '🪨',
		color: '#888888',
		amount: 0,
		workTypes: ['foraging']
	},
	{
		...
		type: 'material',
		category: 'organic',
		description: 'Rough plant fibers suitable for rope and weaving.',
		emoji: '🌿',
		color: '#7EC850',
		amount: 0,
		fuelValue: 2,
	...
	},
	{
		...
		type: 'material',
		category: 'organic',
		description: 'Tree bark. Burns slowly, good fuel.',
		emoji: '🟫',
		color: '#8B5E3C',
		amount: 0,
		fuelValue: 8,
	...
	},
	{
		...
		type: 'material',
		category: 'stone',
		description: 'A loose stone found on the ground.',
		emoji: '🪨',
		color: '#9E9E9E',
		amount: 0,
		workTypes: ['foraging']
	},
	{
		...
		type: 'material',
		category: 'organic',
		description: 'Twisted plant fiber rope. Useful for lashing and construction.',
		emoji: '🧵',
		color: '#C8A064',
		amount: 0,
		fuelValue: 4,
		craftingCost: { plant_fiber: 4 },
		craftingTime: 1,
		toolTierRequired: 0,
	...
	},
	{
		...
		type: 'material',
		category: 'stone',
		description: 'Raw clay scooped from riverbank or deposit.',
		emoji: '🟤',
		color: '#B5651D',
		amount: 0,
		workTypes: ['foraging']
	},
	{
		...
		type: 'material',
		category: 'stone',
		description: 'Sun-dried mud brick. Durable building material.',
		emoji: '🧱',
		color: '#C4A265',
		amount: 0,
		craftingCost: { clay_lump: 2, plant_fiber: 1 },
		craftingTime: 2,
		toolTierRequired: 0,
		workshopType: 'craft_spot',
		workTypes: ['crafting']
	...
	// ===== PHASE 6a — TIER 0 TOOLS (craft_spot) =====
	{
		id: 'firestarter',
		name: 'Firestarter',
		type: 'tool',
		category: 'crafting',
		description: 'Friction-based fire-lighting kit. Used to light campfires.',
		emoji: '🔥',
		color: '#FF6600',
		amount: 0,
		craftingCost: { twig: 2, plant_fiber: 1 },
		craftingTime: 1,
		toolTierRequired: 0,
		workshopType: 'craft_spot',
		workTypes: ['crafting']
	},
	{
		...
		type: 'tool',
		category: 'crafting',
		description: 'A crude knapped flint blade. Enough to cut hide and prepare meat.',
		emoji: '🔪',
		color: '#AAAAAA',
		amount: 0,
		durability: 20,
		maxDurability: 20,
		craftingCost: { flint_shard: 2, plant_fiber: 1 },
		craftingTime: 1,
		toolTierRequired: 0,
		workshopType: 'craft_spot',
		workTypes: ['crafting']
	},
	{
		...
		type: 'tool',
		category: 'crafting',
		description: 'A large flaked stone. Primitive chopping tool.',
		emoji: '🪓',
		color: '#888888',
		amount: 0,
		durability: 15,
		maxDurability: 15,
		craftingCost: { surface_stone: 2, plant_fiber: 1 },
		craftingTime: 1,
		toolTierRequired: 0,
		workshopType: 'craft_spot',
		workTypes: ['crafting']
	},
	{
		...
		type: 'tool',
		category: 'crafting',
		description: 'A hardened stick for digging and levering. Also used for basic fishing.',
		emoji: '🥢',
		color: '#8B6914',
		amount: 0,
		craftingCost: { twig: 2 },
		...
		toolTierRequired: 0,
		workshopType: 'craft_spot',
		workTypes: ['crafting', 'fishing']
	},

	// ===== PHASE 6a — TIER 1 TOOLS (makers_bench) =====
	{
		id: 'stone_axe',
		name: 'Stone Axe',
		type: 'tool',
		category: 'crafting',
		description: 'A hafted stone axe. Proper woodcutting tool.',
		emoji: '🪓',
		color: '#777777',
		amount: 0,
		durability: 40,
		maxDurability: 40,
		craftingCost: { surface_stone: 3, rope: 1, twig: 2 },
		craftingTime: 3,
		toolTierRequired: 0,
		workshopType: 'makers_bench',
		workTypes: ['crafting', 'woodcutting']
	},
	{
		id: 'stone_hammer',
		name: 'Stone Hammer',
		type: 'tool',
		category: 'crafting',
		description: 'A heavy stone maul. Used for construction and stoneworking.',
		emoji: '🔨',
		color: '#888888',
		amount: 0,
		durability: 40,
		maxDurability: 40,
		craftingCost: { surface_stone: 3, rope: 2 },
		craftingTime: 3,
		toolTierRequired: 0,
		workshopType: 'makers_bench',
		workTypes: ['crafting', 'construction']
	},
	{
		id: 'stone_spear',
		name: 'Stone Spear',
		type: 'weapon',
		category: 'combat',
		description: 'A flint-tipped wooden spear. The first proper hunting weapon.',
		emoji: '🗡️',
		color: '#999999',
		amount: 0,
		durability: 30,
		maxDurability: 30,
		craftingCost: { twig: 3, flint_shard: 2, rope: 1 },
		craftingTime: 3,
		toolTierRequired: 0,
		workshopType: 'makers_bench',
		weaponProperties: { damage: 8, attackSpeed: 1, range: 1 },
		workTypes: ['crafting', 'hunting']
	},
	{
		id: 'stone_spade',
		name: 'Stone Spade',
		type: 'tool',
		category: 'crafting',
		description: 'A flat-bladed stone spade. Used for digging and earth-moving.',
		emoji: '⛏️',
		color: '#888888',
		amount: 0,
		durability: 35,
		maxDurability: 35,
		craftingCost: { surface_stone: 4, rope: 1, twig: 2 },
		craftingTime: 3,
		toolTierRequired: 0,
		workshopType: 'makers_bench',
		workTypes: ['crafting', 'construction', 'mining']
	},

	// ===== PHASE 6a — FOOD (campfire cooking) =====
	{
		id: 'spit_meat',
		name: 'Spit-Roasted Meat',
		type: 'consumable',
		category: 'food',
		description: 'Meat cooked over an open fire on a stick. Simple but filling.',
		emoji: '🍖',
		color: '#C8864E',
		amount: 0,
		nutrition: 3.0,
		craftingCost: { rabbit_meat: 1, twig: 2 },
		craftingTime: 2,
		toolTierRequired: 0,
		workshopType: 'campfire',
		consumableProperties: { uses: 1, consumeTime: 2 },
		workTypes: ['cooking']
	},
	{
		id: 'stew',
		...
		type: 'consumable',
		category: 'food',
		description: 'A hearty stew made from available ingredients. Requires a clay cooking pot.',
		emoji: '🍲',
		color: '#C87941',
		amount: 0,
		nutrition: 5.0,
		craftingCost: { clay_lump: 0 }, // overridden per-instance; placeholder to show in crafting screen
		craftingTime: 3,
		toolTierRequired: 0,
		workshopType: 'campfire',
		isCookingVessel: false,  // result is not a vessel
		components: [],          // populated when queued
		consumableProperties: { uses: 1, consumeTime: 3 },
		workTypes: ['cooking']
	},

	// ===== PHASE 6a — CRAFTED GOODS =====
	{
		id: 'clay_cooking_pot',
		name: 'Clay Cooking Pot',
		type: 'tool',
		category: 'crafting',
		description: 'A rough but functional clay pot. Required to cook stews at the campfire.',
		emoji: '🫕',
		color: '#B5651D',
		amount: 0,
		durability: 30,
		maxDurability: 30,
		isCookingVessel: true,
		craftingCost: { clay_lump: 2 },
		craftingTime: 2,
		toolTierRequired: 0,
		workshopType: 'campfire',
		workTypes: ['crafting']
	},
	{
		...
		type: 'material',
		category: 'crafting',
		description: 'A woven plant-fiber basket. Useful for carrying and light storage.',
		emoji: '🧺',
		color: '#C8A064',
		amount: 0,
		isContainer: true,
		storageCapacity: 5,
		craftingCost: { plant_fiber: 6 },
		craftingTime: 2,
		toolTierRequired: 0,
		workshopType: 'craft_spot',
		workTypes: ['crafting']
	},
	{
		...
		type: 'material',
		category: 'crafting',
		description: 'A hand-shaped clay pot. Keeps food fresh longer.',
		emoji: '🏺',
		color: '#B5651D',
		amount: 0,
		isContainer: true,
	...
	},
	{
		...
		type: 'material',
		category: 'crafting',
		description: 'A large sealed clay jar. Excellent food preservation for long-term storage.',
		emoji: '🫙',
		color: '#B5651D',
		amount: 0,
		isContainer: true,
		storageCapacity: 30,
		preservationBonus: 0.7,
		craftingCost: { clay_lump: 5, rope: 2 },
		craftingTime: 5,
		toolTierRequired: 0,
		workshopType: 'makers_bench',
		workTypes: ['crafting']
	},
	{
		...
		description: 'Strips of processed hide. Used in tool hafting and armor.',
		emoji: '🟫',
		color: '#8B5E3C',
		amount: 0,
		craftingCost: { hide: 1, flint_knife: 0 }, // flint_knife as tool, not consumed
		craftingTime: 2,
		toolTierRequired: 0,
		workshopType: 'craft_spot',
		workTypes: ['crafting', 'leatherworking']
	}
];
