...
export const AVAILABLE_BUILDINGS: Building[] = [
  ...
  // ===== PHASE 6b — PRIMITIVE PRODUCTION BUILDINGS =====
  {
    id: 'campfire',
    name: 'Campfire',
    description: 'A simple fire pit. Provides warmth, cooking, and a place for colonists to gather food. Requires fuel and lighting.',
    emoji: '🔥',
    color: '#FF6600',
    ...
    productionBonus: {},
    storageCapacity: {},
    // Phase 6: fire semantics
    requiresLighting: true,
    maxFuel: 60,
    fuelConsumptionRate: 1,
    isStorage: true,
    buildingState: { isUnique: false, maxCount: 5 }
  },
  {
    id: 'craft_spot',
    name: 'Craft Spot',
    description: 'A cleared ground area for primitive hand-crafting. No tools required to build.',
    emoji: '🪨',
    color: '#C8A064',
    buildingCost: {},
    buildTime: 0,
    ...
    productionBonus: {},
    storageCapacity: {},
    buildingState: { isUnique: false }
  },
  {
    id: 'makers_bench',
    name: "Maker's Bench",
    description: 'A rough work bench assembled from found materials. Enables Tier 1 tool crafting.',
    emoji: '🪚',
    color: '#8B6914',
    buildingCost: { flint_knife: 1, stone_chopper: 1, stone_axe: 1, stone_hammer: 1, twig: 15, rope: 4 },
    buildTime: 4,
    toolTierRequired: 0,
    populationRequired: 1,
    researchRequired: null,
    ...
    productionBonus: {},
    storageCapacity: {},
    buildingState: { isUnique: false, maxCount: 3 }
  },

  // ===== PHASE 6d — WALLS & DOORS =====
  {
    id: 'twig_wall',
    name: 'Twig Wall',
    description: 'A flimsy wall made from lashed twigs. Barely slows attackers but defines a space.',
    emoji: '🪵',
    color: '#8B6914',
    buildingCost: { twig: 8, plant_fiber: 2 },
    buildTime: 1,
    toolTierRequired: 0,
    populationRequired: 1,
    researchRequired: null,
  ...
  },
  {
    id: 'wicker_wall',
    name: 'Wicker Wall',
    description: 'Woven plant-fiber wall panels. Sturdier than twig walls, good windbreak.',
    emoji: '🟤',
    color: '#C8A064',
    buildingCost: { plant_fiber: 12, twig: 4 },
    buildTime: 2,
    toolTierRequired: 0,
    populationRequired: 1,
    researchRequired: null,
    ...
    category: 'military',
    upkeepCost: {},
    effects: { movementCost: 99, weatherProtection: 0.2 },
    productionBonus: {},
    storageCapacity: {}
  },
  {
    id: 'daub_wall',
    name: 'Daub Wall',
    description: 'Wicker reinforced with clay daub. Solid, weather-resistant wall.',
    emoji: '🧱',
    color: '#B5651D',
    buildingCost: { plant_fiber: 8, clay_lump: 6, twig: 4 },
    buildTime: 3,
    toolTierRequired: 0,
    populationRequired: 1,
    researchRequired: null,
    ...
    category: 'military',
    upkeepCost: {},
    effects: { movementCost: 99, weatherProtection: 0.4 },
    productionBonus: {},
    storageCapacity: {}
  },
  {
    id: 'mud_brick_wall',
    name: 'Mud Brick Wall',
    description: 'A wall of sun-dried mud bricks. Proper permanent construction.',
    emoji: '🧱',
    color: '#C4A265',
    buildingCost: { mud_brick: 10 },
    buildTime: 4,
    toolTierRequired: 0,
    populationRequired: 1,
    researchRequired: null,
    ...
    category: 'military',
    upkeepCost: {},
    effects: { movementCost: 99, weatherProtection: 0.6 },
    productionBonus: {},
    storageCapacity: {}
  },
  {
    id: 'twig_door',
    name: 'Twig Door',
    description: 'A simple hinged frame of lashed twigs. Marks an entrance through a wall.',
    emoji: '🚪',
    color: '#8B6914',
    buildingCost: { twig: 6, plant_fiber: 2 },
    buildTime: 1,
    toolTierRequired: 0,
    populationRequired: 1,
    researchRequired: null,
