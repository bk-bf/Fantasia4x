...
echo "  pre-push    refuses a new branch not named <type>/<title> or <type>/<title>-<issue number>,"
echo "              e.g. fix/stealth-encounter-pacing-42, and runs the ticks-per-second leg on"
echo "              the server when tools/audit/ci-scope.mjs says the pushed commit needs it."
